...
def outside_program():
    ...
    def pokemon():
        ...
        pikachu.title('deadspy-vibes')
        raichu=Label(pikachu,text="Vibes Registration",font=("Arial Black",30,"bold"),bg="orange",fg="black")
        raichu.pack(side=TOP,fill=X)
        """ Connect to MySQL database """
        ''''''
        status_Frame=Frame(pikachu,bd=1,highlightthickness=3,highlightbackground="orange",relief=SUNKEN,bg="orange")
        status_Frame.place(x=50,y=530,width=315,height=170)
        STATS=Label(status_Frame,text='STATUS',bg='orange',fg='black',font=("Arial Black",15,"bold"))
        STATS.pack()
        IC=Label(status_Frame,text='Internet Connection    : ',bg='orange',fg='black')
        IC.place(x=10,y=30)
        VIBEDBCON=Label(status_Frame,text='Database Connection : ',bg='orange',fg='black')
        VIBEDBCON.place(x=10,y=60)
        ''''''
        ...
        conn=('Connected' if connect() else 'Disconnected')
        connections=Label(status_Frame,text=conn,bg='black',fg='orange',width=15)
        connections.place(x=170,y=30)
        try:
            con = mysql.connector.connect(host='b05kt9leae6k0e0pw3oi-mysql.services.clever-cloud.com',user='uxo4dmiarzmuny04',passwd='0zxcTbuUooDbEZc3GUBq')
            cur= con.cursor()
            constats='Connected'  if con.is_connected() else 'NOT Connected'
            VIBEDBCONconnections=Label(status_Frame,text=constats,bg='black',fg='orange',width=15)
            VIBEDBCONconnections.place(x=170,y=60)
        except Exception:
            VIBEDBCONconnections=Label(status_Frame,text='Disconnected',bg='black',fg='orange',width=15)
            VIBEDBCONconnections.place(x=170,y=60)
            ''''''    
        try:
            con = mysql.connector.connect(host='b05kt9leae6k0e0pw3oi-mysql.services.clever-cloud.com',user='uxo4dmiarzmuny04',passwd='0zxcTbuUooDbEZc3GUBq')
            ...
            cur.execute('use b05kt9leae6k0e0pw3oi')
            '''Creating Database'''
            cur.execute("CREATE TABLE IF NOT EXISTS Students_database(fName varchar(16),lName varchar(16),STD varchar(6),Email_ID text ,College_Name text ,Mobile_No DECIMAL(10),Gender varchar(8),Totalammo int default NULL ,Box_Cricket varchar(6),Rink_Football varchar(6),Badminton varchar(6),Carrom_Solo varchar(6),Carrom_Duo varchar(6),Table_Tennis varchar(6),Chess varchar(6),Counter_Strike_Five_M varchar(6),Counter_Strike_Three_M varchar(6),Pubg_Solo varchar(6),Pubg_Squad varchar(6),Pubg_TDM varchar(6),Pubg_Squad_TDM varchar(6),Dance_Solo varchar(6),Dance_Group_Duo varchar(6),Dance_Group_Squad varchar(6),Fifa varchar(6),Singing varchar(6),Rapping varchar(6),Beatboxing varchar(6),Photography varchar(6),Mehndi varchar(6))")
            con.commit()
        except :
            ''''''
        ...
        def reg_button_1():
            ...
            def pokeball():
                ...
                try:   
                                ...
                                if len(deadspy_email)>30 or len(deadspy_email)<6:
                                    ...
                                    if '@'  not in deadspy_email:
                                        ...
                                        if len(CLG)>25 or len(CLG)<2:
                                            ...
                                            v=cur.execute('select * from Students_database')
                                            vo=str(cur.fetchall())
                                            ...
                                            if  len(oneplus)<10:
                                                ...
                                                if MF == "Male" or MF == "Female":
                                                    ...
                                                    cur.execute(f'Insert Into Students_database values("{fnames}","{lnames}","{std}","{deadspy_email}","{CLG}","{oneplus}","{MF}",NULL,"","","","","","","","","","","","","","","","","","","","","","")')
                                                    ...
                                                    def BC():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Box_Cricket = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            #dead=cur.execute("select * from Students_database;")
                                                            ...
                                                            bj=sum(TotalSum)
                                                            cur.execute(f'Update Students_database set Totalammo = "{bj}"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Box_Cricket = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            RF()
                                                            BD()
                                                            CRS()
                                                    ...
                                                    def RF():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Rink_Football = "yes"  where Mobile_No="{oneplus}"  ')
                                                            ...
                                                            cur.execute(f'Update Students_database set Rink_Football = "no"  where Mobile_No="{oneplus}"  ')
                                                            ''''''
                                                    ...
                                                    def BD():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Badminton = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Badminton = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def CRS():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Carrom_Solo = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p4p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Carrom_Solo = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def CRD():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Carrom_Duo = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Carrom_Duo = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def TT():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Table_Tennis = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p5p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Table_Tennis = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def CSS():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Chess = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p6p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Chess = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def CT5():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Counter_Strike_Five_M = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p7p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Counter_Strike_Five_M = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def CT3():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Counter_Strike_Three_M = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Counter_Strike_Three_M = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def PGS():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Pubg_Solo = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p8p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Pubg_Solo = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def PGD():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Pubg_Squad = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Pubg_Squad = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def PGT():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Pubg_TDM = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Pubg_TDM = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def PGST():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Pubg_Squad_TDM = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Pubg_Squad_TDM = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def DCS():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Dance_Solo = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            TotalSum.append(p9p)
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Dance_Solo = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def DSD():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Dance_Group_Duo = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Dance_Group_Duo = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def DSG():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Dance_Group_Squad = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Dance_Group_Squad = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def FF():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Fifa = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Fifa = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def SG():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Singing = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Singing = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def RP():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Rapping = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Rapping = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def BTBX():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Beatboxing = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Beatboxing = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def PGY():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Photography = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Photography = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                    ...
                                                    def MDI():
                                                        ...
                                                        if brock == 1:
                                                            ...
                                                            cur.execute(f'Update Students_database set Mehndi = "yes"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                                                            ...
                                                            ''''''
                                                            cur.execute(f'Update Students_database set Mehndi = "no"  where Mobile_No="{oneplus}"  ')
                                                            con.commit()
                    ...
                    ''''''
                    showerror("NO INTERNET","Error \nIF YOU ARE CONNECTED PLEASE RESTART THE APPLICATION")  
                except Exception :
                            ''''''                           
                ...
                if hoho=="cec":
                    ...
                    def Pupdates():
                        ...
                        def selector(ev):
                            ...
                            select_row=jay.focus()
                            cdata=jay.item(select_row)
                            row=cdata['values']
                            ...
                            try:
                                ...
                                ''''''
                        jay.bind("<ButtonRelease-1>",selector) 
                        def backbtn000():
                            ''''''
                            imraan.place_forget()
                            ved.place_forget()
                    ...
                    def deletesoftskills():
                        ...
                        try:
                            ...
                            cur.execute(f'Delete  From Students_database where Mobile_No="{oneplus}"')
                            con.commit()
                            for i in jay.get_children():
                                jay.delete(i)
                    ...
                    ajayC=Button(shubham_y,cursor='hand2',relief=RIDGE,highlightcolor='orange',highlightbackground='orange',highlightthickness=1,activebackground="black",border=0,activeforeground="orange",text="Delete",command=deletesoftskills,fg='black',bg='orange',height=2,width=14)
                    ajayC.grid(row=0,column=1,padx=10,pady=9)
                    ...
                    def showalldata():
                        ...
                        try:
                            ...
                            cur.execute("Select * From Students_database")
                            rows=cur.fetchall()
                            if len(rows)!=0:
                                jay.delete(*jay.get_children())
                                for row in rows:
                                    jay.insert('',END,values=row)
                                    con.commit()
                        except NameError:
                            showerror("NO INTERNET","Error \nIF YOU ARE CONNECTED PLEASE RESTART THE APPLICATION")  
                        except Exception :
                    ...
                    def nobody_search():
                        ...
                        try:
                            cur.execute(f'select * from Students_database WHERE {shm} = "yes"  ;')
                            rows=cur.fetchall()
                            if len(rows)!=0:
                                jay.delete(*jay.get_children())
                                for row in rows:
                    ...
                    def pdfdn():
                        ''''''
                        syntax="select * from Students_database"
                        cur.execute(syntax)
                        with open("vibes_online_data_text.csv","w") as d:
                        ...
                        def notification():
                            ''''''
                            notbutton.configure(state=DISABLED)
                            subprocess.Popen(['wps','vibes_online_data_text.csv']).wait()
                    ...
                    jay=ttk.Treeview(Pradeep_K,columns=('fname','lname','std','deadspy_email','CLG','oneplus','MF','Totalammo'),xscrollcommand=justscrollitx.set,yscrollcommand=justscrollity.set)
                    justscrollitx.pack(side=BOTTOM,fill=X)
                    justscrollity.pack(side=RIGHT,fill=Y)
                    justscrollitx.config(command=jay.xview)
                    justscrollity.config(command=jay.yview)
                    
                    jay.heading('fname',text='First Name')
                    jay.heading('lname',text='Last Name')
                    jay.heading('std',text='Standard')
                    jay.heading('deadspy_email',text='Email ID')
                    jay.heading('CLG',text='College')
                    jay.heading('oneplus',text='Mobile No.')
                    jay.heading('MF',text='Gender')
                    jay.heading('Totalammo',text='Paid Ammount')
                    
                    jay['show']='headings'
                    jay.column('fname',width=100)
                    jay.column('lname',width=100)
                    jay.column('std',width=100)
                    jay.column('deadspy_email',width=100)
                    jay.column('CLG',width=100)
                    jay.column('oneplus',width=100)
                    jay.column('MF',width=100)
                    jay.column('Totalammo',width=100)
                    
                    jay.pack(fill=BOTH,expand=1)
                    ...
                    def selector1(ev):
                        ...
                        try:
                            ...
                            ''''''
                    jay.bind("<ButtonRelease-1>",selector1)        
        ...
        Admin_label=Label(pikachu,font=("Arial Black",15,"bold"),text='Admin-Log-In',bd=0,highlightthickness=0,bg='black',fg='orange')
        Admin_label.place(x=494,y=690)
        ...
        Exit_button=Button(pikachu,cursor='hand2',text='Exit',bd=0,highlightthickness=2,highlightbackground='orange',highlightcolor='orange',activebackground="black",image=photoE,width=170,height=170,bg="black",command=Exit_button_6)
        Exit_button.place(x=690,y=530)

        Exit_label=Label(pikachu,font=("Arial Black",15,"bold"),text='Exit',bd=0,highlightthickness=0,bg='black',fg='orange')
        Exit_label.place(x=756,y=690)
